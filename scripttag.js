...
const my_param = url_object.searchParams.get("ref");

console.log(my_param);
if (my_param != null) {

    //set cookie
    setCookie('ref', my_param);

} else {

    //get cookie
    let my_param_cookie = getCookie('ref');
    ...
    if (my_param_cookie) {
        ...
        const url_my_param = my_param == null ? 'ref=' + my_param_cookie : my_param;
